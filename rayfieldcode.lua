	...
	Theme = {
		...
		Elysium = {
			...
			RedOrange = {
				...
				Topbar = Color3.fromRGB(150, 70, 0),
				Shadow = Color3.fromRGB(160, 80, 0),
				NotificationBackground = Color3.fromRGB(180, 100, 30),
				NotificationActionsBackground = Color3.fromRGB(200, 120, 60),
				TabBackground = Color3.fromRGB(180, 100, 30),
				TabStroke = Color3.fromRGB(160, 80, 0),
				TabBackgroundSelected = Color3.fromRGB(170, 90, 10),
				TabTextColor = Color3.fromRGB(255, 255, 255),
				SelectedTabTextColor = Color3.fromRGB(255, 255, 255),
				ElementBackground = Color3.fromRGB(170, 90, 10),
				ElementBackgroundHover = Color3.fromRGB(180, 100, 30),
				SecondaryElementBackground = Color3.fromRGB(190, 110, 40),
				ElementStroke = Color3.fromRGB(200, 120, 60),
				SecondaryElementStroke = Color3.fromRGB(210, 130, 70),
				SliderBackground = Color3.fromRGB(200, 120, 60),
				SliderProgress = Color3.fromRGB(210, 130, 70),
				SliderStroke = Color3.fromRGB(220, 140, 80),
				ToggleBackground = Color3.fromRGB(170, 90, 10),
				ToggleEnabled = Color3.fromRGB(220, 140, 80),
				ToggleDisabled = Color3.fromRGB(190, 110, 40),
				ToggleEnabledStroke = Color3.fromRGB(230, 150, 90),
				ToggleDisabledStroke = Color3.fromRGB(200, 120, 60),
				ToggleEnabledOuterStroke = Color3.fromRGB(230, 150, 90),
				ToggleDisabledOuterStroke = Color3.fromRGB(170, 90, 10),
				DropdownSelected = Color3.fromRGB(170, 90, 10),
				DropdownUnselected = Color3.fromRGB(190, 110, 40),
				InputBackground = Color3.fromRGB(190, 110, 40),
				InputStroke = Color3.fromRGB(200, 120, 60),
				PlaceholderColor = Color3.fromRGB(240, 250, 255)
            },
